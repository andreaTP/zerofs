...
import static io.roastedroot.zerofs.core.UserLookupService.createGroupPrincipal;
  ...
  public Map<String, ?> defaultValues(Map<String, ?> userProvidedDefaults) {
    ...
    if (userProvidedPermissions != null) {
      if (userProvidedPermissions instanceof String) {
        permissions = Set.copyOf(PosixFilePermissions.fromString((String) userProvidedPermissions));
