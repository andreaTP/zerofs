...
final class FileTree {
  ...
  public DirectoryEntry lookUp(
      File workingDirectory, ZeroFsPath path, Set<? super LinkOption> options) throws IOException {
  ...
  private DirectoryEntry lookUp(
      File dir, ZeroFsPath path, Set<? super LinkOption> options, int linkDepth) throws IOException {
