...
final class FileSystemView {
  ...
  public ZeroFsPath toRealPath(
      ZeroFsPath path, PathService pathService, Set<? super LinkOption> options) throws IOException {
   ...
   * possible.
   */
  public Directory createDirectory(ZeroFsPath path, FileAttribute<?>... attrs) throws IOException {
  ...
  public Map<String, Object> readAttributes(
      ZeroFsPath path, String attributes, Set<? super LinkOption> options) throws IOException {
    File file = lookUpWithLock(path, options).requireExists(path).file();
