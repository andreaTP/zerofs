...
import static io.roastedroot.zerofs.core.SystemZeroFsFileSystemProvider.FILE_SYSTEM_KEY;
...
public final class ZeroFs {
    ...
    /** The URI scheme for the Jimfs file system ("zerofs"). */
        ...
        try {
            ...
            LOGGER.log(
                    ...
                    "An exception occurred when attempting to find the system-loaded"
                        + " FileSystemProvider for Jimfs. This likely means that your environment"
                        + " does not support loading services via ServiceLoader or is not"
                        + " configured correctly. This does not prevent using Jimfs, but it will"
